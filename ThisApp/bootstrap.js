...
Ext.Loader.addClassPathMappings({
  ...
  "ThisApp": "app",
  "ThisApp.view.InviteUnRegisterUserView": "app/view/InviteUnregisterUserView.js"
});
Ext.ClassManager.addNameAlternateMappings({
  ...
  "ThisApp.controller.BottomBarController": [],
  "ThisApp.controller.CreateUserAccountController": [],
  "ThisApp.controller.EventDetailsController": [],
  "ThisApp.controller.EventWallController": [],
  "ThisApp.controller.EventsController": [],
  "ThisApp.controller.ForgotPasswordController": [],
  "ThisApp.controller.InviteController": [],
  "ThisApp.controller.LoginController": [],
  "ThisApp.controller.NewEventsController.NewEvent1Controller": [],
  "ThisApp.controller.NewEventsController.NewEvent2Controller": [],
  "ThisApp.controller.NewEventsController.NewEvent3Controller": [],
  "ThisApp.controller.NewEventsController.NewEvent4Controller": [],
  "ThisApp.controller.SetEventLocationController": [],
  "ThisApp.controller.SettingsController": [],
  "ThisApp.model.BaseModel": [],
  "ThisApp.model.ContactsModel": [],
  "ThisApp.model.CountryModel": [],
  "ThisApp.model.EventWallModel": [],
  "ThisApp.model.EventsInvitedContactsModel": [],
  "ThisApp.model.EventsModel": [],
  "ThisApp.model.LoginModel": [],
  "ThisApp.model.NewEventsModel.EventModel": [],
  "ThisApp.model.NewEventsModel.EventTypeModel": [],
  "ThisApp.model.NewEventsModel.HoursModel": [],
  "ThisApp.model.NewEventsModel.PhoneContactsModel": [],
  "ThisApp.model.NewEventsModel.ReoccurringDurationModel": [],
  "ThisApp.model.NewEventsModel.SpacesLeftModel": [],
  "ThisApp.model.UserEventModel": [],
  "ThisApp.model.UserModel": [],
  "ThisApp.store.ContactsStore": [],
  "ThisApp.store.CountryStore": [],
  "ThisApp.store.EventWallStore": [],
  "ThisApp.store.EventsInvitedContactsStore": [],
  "ThisApp.store.NewEventsStore.EventStore": [],
  "ThisApp.store.NewEventsStore.EventTypeStore": [],
  "ThisApp.store.NewEventsStore.HoursStore": [],
  "ThisApp.store.NewEventsStore.PhoneContactStore": [],
  "ThisApp.store.NewEventsStore.ReoccurringDurationStore": [],
  "ThisApp.store.NewEventsStore.SpacesLeftStore": [],
  "ThisApp.store.UserInvitedEventsStore": [],
  "ThisApp.store.UserPastEventsStore": [],
  "ThisApp.store.UserStore": [],
  "ThisApp.store.UserSubscribedEventsStore": [],
  "ThisApp.util.CommonUtil": [],
  "ThisApp.util.GlobalUtil": [],
  "ThisApp.view.CheckVerificationCodeView": [],
  "ThisApp.view.CustomizedSelectFieldView": [],
  "ThisApp.view.DeleteAccountView": [],
  "ThisApp.view.EnterPasswordView": [],
  "ThisApp.view.ErrorView": [],
  "ThisApp.view.EventDetailsView": [],
  "ThisApp.view.EventParticipantsView": [],
  "ThisApp.view.EventWallView": [],
  "ThisApp.view.EventsView": [],
  "ThisApp.view.FeedbackView": [],
  "ThisApp.view.ForgotPasswordView": [],
  "ThisApp.view.GetEventLocationView": [],
  "ThisApp.view.InviteOthersView": [],
  "ThisApp.view.InviteRegisterUserView": [],
  "ThisApp.view.InviteUnRegisterUserView": [],
  "ThisApp.view.LoginView": [],
  "ThisApp.view.NewEventsView.NewEvent1View": [],
  "ThisApp.view.NewEventsView.NewEvent2View": [],
  "ThisApp.view.NewEventsView.NewEvent3View": [],
  "ThisApp.view.NewEventsView.NewEvent4View": [],
  "ThisApp.view.NewUserView": [],
  "ThisApp.view.ResetPasswordView": [],
  "ThisApp.view.SetEventLocationView": [],
  "ThisApp.view.SettingsView": [],
  "ThisApp.view.WallNotificationSettingView": [],
  "ThisApp.view.widgets.CustomizedSelect": [],
  "ThisApp.view.widgets.DisplayMessageOverlay": [],
  "ThisApp.view.widgets.HourMinutePicker": [],
  "ThisApp.view.widgets.HourMinutePickerField": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "ThisApp.util.GlobalUtil": [],
  "ThisApp.view.CheckVerificationCodeView": [
    "widget.checkVerificationCodeView"
  ],
  "ThisApp.view.CustomizedSelectFieldView": [
    "widget.customizedSelectField"
  ],
  "ThisApp.view.DeleteAccountView": [
    "widget.deleteAccountView"
  ],
  "ThisApp.view.EnterPasswordView": [
    "widget.enterPasswordView"
  ],
  "ThisApp.view.ErrorView": [],
  "ThisApp.view.EventDetailsView": [
    "widget.eventDetailsView"
  ],
  "ThisApp.view.EventParticipantsView": [
    "widget.eventParticipantsView"
  ],
  "ThisApp.view.EventWallView": [
    "widget.eventWallView"
  ],
  "ThisApp.view.EventsView": [
    "widget.eventsView"
  ],
  ...
  "ThisApp.view.GetEventLocationView": [
    "widget.getEventLocationView"
  ],
  "ThisApp.view.InviteOthersView": [
    "widget.inviteOthersView"
  ],
  "ThisApp.view.InviteRegisterUserView": [
    "widget.InviteRegisterUserView"
  ],
  "ThisApp.view.InviteUnRegisterUserView": [
    "widget.InviteUnRegisterUserView"
  ],
  "ThisApp.view.LoginView": [
    "widget.loginView"
  ],
  "ThisApp.view.NewEventsView.NewEvent1View": [
    "widget.NewEvent1View"
  ],
  "ThisApp.view.NewEventsView.NewEvent2View": [
    "widget.newEvent2View"
  ],
  "ThisApp.view.NewEventsView.NewEvent3View": [
    "widget.newEvent3View"
  ],
  "ThisApp.view.NewEventsView.NewEvent4View": [
    "widget.newEvent4View"
  ],
  "ThisApp.view.NewUserView": [
    "widget.newUserView"
  ],
  ...
  "ThisApp.view.SetEventLocationView": [
    "widget.setEventLocationView"
  ],
  "ThisApp.view.SettingsView": [
    "widget.settingsView"
  ],
  "ThisApp.view.WallNotificationSettingView": [
    "widget.wallNotificationSettingView"
  ],
  "ThisApp.view.widgets.CustomizedSelect": [
    "widget.customizedSelect"
  ],
  "ThisApp.view.widgets.DisplayMessageOverlay": [
    "widget.displayMessageOverlay"
  ],
  "ThisApp.view.widgets.HourMinutePicker": [
    "widget.hourMinutePicker"
  ],
  "ThisApp.view.widgets.HourMinutePickerField": [
    "widget.hourMinutePickerField"
  ]
});
